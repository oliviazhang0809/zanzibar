...
{{- $reqHeaderMapKeys := sortedHeaders .ReqHeaders false}}
{{- $reqHeaderRequiredKeys := sortedHeaders .ReqHeaders true}}
{{- $resHeaderMap := .ResHeaders }}
{{- $resHeaderMapKeys := sortedHeaders .ResHeaders false}}
{{- $resHeaderRequiredKeys := sortedHeaders .ResHeaders true}}
...
func endpointTmpl() (*asset, error) {
	...
	info := bindataFileInfo{name: "endpoint.tmpl", size: 11187, mode: os.FileMode(420), modTime: time.Unix(1, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
